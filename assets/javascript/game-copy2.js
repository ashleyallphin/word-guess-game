...
//variable to hold the number of wins; starts at 0
var wins = 0;
//variable to hold the number of attempts left; starts with 10
var attemptsLeft = 10;
...
var answerLength = (answer.replace(/[^A-Z]/gi, "").length);
...
document.onkeyup = function(event) {
    ...
    var removed1 = userDirectionsParent.removeChild(userDirections);
        ...
        //removes getStarted and stores it in the variable "removed2"
